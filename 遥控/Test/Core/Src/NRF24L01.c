...
/*接收部分*/
uint8_t NRF24L01_RxAddress[5] = {0x22, 0x11, 0x22, 0x11, 0x66};		//接收通道0地址，固定5字节
...
/**
  ...
  */
	void NRF24L01_W_CE(uint8_t BitValue) //CE(B6)
{
...
/**
  ...
  */
void NRF24L01_W_CSN(uint8_t BitValue) //CSN(B7)
{
...
/**
  ...
  */
void NRF24L01_W_SCK(uint8_t BitValue) //SCK(A5)
{
...
/**
  ...
  */
void NRF24L01_W_MOSI(uint8_t BitValue) //MOSI(B5)
{
...
/**
  ...
  */
uint8_t NRF24L01_R_MISO(void) //MISO(B4)
{
	/*取MISO引脚的高低电平并返回*/
